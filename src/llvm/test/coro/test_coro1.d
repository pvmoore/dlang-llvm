module llvm.test.coro.test_coro1;
...
public:
    ...
    void testSingleSuspendPoint() {
        ...
        auto mod  = wrapper.createModule("CoroTest1");
        auto f    = createF(mod);
    ...
    */
    ...
    // entry
        ...
        auto id = builder.ccall(mod.getOrAddIntrinsicFunction("llvm.coro.id"), [
                constI32(0),                            // align
                constNullPointer(bytePointerType()),    // promise
                constNullPointer(bytePointerType()),    // null
                constNullPointer(bytePointerType())     // null
            ], "id");
